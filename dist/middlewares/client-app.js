...
const isAuthorize = (req) => __awaiter(void 0, void 0, void 0, function* () {
...
class Middleware {
    ...
    isAuthorizeForLogin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield isAuthorize(req))) {
    ...
    isAuthorizeForRefresh(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield isAuthorize(req))) {
                req.session.isAuth = false;
                req.session.destroy((err) => {
